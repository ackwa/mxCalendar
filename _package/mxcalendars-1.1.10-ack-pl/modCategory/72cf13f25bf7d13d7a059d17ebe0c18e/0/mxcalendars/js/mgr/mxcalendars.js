...
mxcCore.combo.Tags = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        store: new Ext.data.JsonStore({
            root: 'results',
    ...
    mxcCore.combo.Tags.superclass.constructor.call(this,config);
};
Ext.extend(mxcCore.combo.Tags,MODx.combo.ComboBox);
Ext.reg('mxc-combo-tag',mxcCore.combo.Categories);