mxcCore.grid.events = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        fields: ['id',
            ...
            'repeaton',
            'repeatfrequency', {
                name: 'repeatenddate', type: 'date', dateFormat: 'timestamp'},
            'repeatdates',
            'menu',
            'name',
            'map',
            ...
            'catfriendly',
            'allday'],
        paging: true, remoteSort: true, anchor: '97%', autoExpandColumn: 'name', save_action: 'mgr/events/updatefromgrid' // Support the inline editing
        ...
        , columns: [
            ...
            {
                xtype: 'textfield', id: 'mxcalendars-search-filter', emptyText: _('mxcalendars.search_default_text'), listeners: {
            ...
            '->',
            {
                text: _('mxcalendars.btn_show_past_events'), id: 'pastbnt', visible: true, handler: function () {
                var s = this.getStore();
            ...
            {
                text: _('mxcalendars.btn_show_upcoming_events'), id: 'futurebnt', hidden: true, handler: function () {
                var s = this.getStore();
            ...
            '-',
            {
                text: _('mxcalendars.btn_create'), handler: this.createCal
            }
        ]
    });
...
Ext.extend(mxcCore.grid.events, MODx.grid.Grid, {
    search: function (tf, nv, ov) {
        ...
        var m = [
            {
                text: _('mxcalendars.event_title_update'), handler: this.updateCal
            },
            '-',
            {
                text: _('mxcalendars.event_title_duplicate'), handler: this.duplicateEvent
            },
            '-',
            {
                text: _('mxcalendars.event_title_remove'), handler: this.removeCal
            }
        ];
        ...
        this.createCalWindow = MODx.load({
            xtype: 'mxcalendars-window-mxcalendar-create', record: {'repeaton': ''}
        });
        ...
        this.updateCalWindow = MODx.load({
            ...
            record: this.menu.record, listeners: {
        ...
        MODx.msg.confirm({
            title: _('mxcalendars.mxcalendars_remove'), text: _('mxcalendars.mxcalendars_remove_confirm'), url: this.config.url, params: {
                action: 'mgr/events/remove', id: this.menu.record.id
            }, listeners: {
                'success': {fn: this.refresh, scope: this}
            }
        });
        ...
        this.createCalWindow = MODx.load({
            xtype: 'mxcalendars-window-mxcalendar-create', record: cloneRec
        });
        this.createCalWindow.show(e.target);
    }
});
...
mxcCore.window.CreateCal = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        title: _('mxcalendars.event_title_create'), autoHeight: false, height: Ext.getBody().getViewSize().height * .85, autoScroll: true, id: 'CreateCal', url: mxcCore.config.connectorUrl, width: 870, baseParams: {
            action: 'mgr/events/create'
        }, closeAction: 'hide', border: false, bodyStyle: 'padding:15px', plain: true, fieldDefaults: {
            //msgTarget: 'side'
        }, defaults: {
            // applied to each contained item
            // nothing this time
            anchor: '100%', layout: 'Form', labelWidth: '100', cellCls: 'valign-center'
        }, items: [
            {
                xtype: 'container',
                anchor: '0',
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                items: [
                                    {boxLabel: _('mxcalendars.label_allday'), name: 'allday', id: 'callday', xtype: 'checkbox', checked: config.record.allday ? true : false, listeners: {check: {fn: function (tht, value) {
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        fieldLabel: 'Occurs', name: 'repeattype', id: 'crepeattype', xtype: 'combo', mode: 'local', store: new Ext.data.ArrayStore({
                        id: 0,
                        fields: ['v', 'measure'],
                        data: [
                    ...
                    }), triggerAction: 'all', displayField: 'measure', valueField: 'v', editable: true, width: 150, layout: 'anchor', anchor: '100% 100%', value: config.record.repeattype, listeners: {select: {fn: function (combo, value) {
                    ...
                    {
                        fieldLabel: _('mxcalendars.label_repeaton'), name: 'repeaton', id: 'crepeaton', xtype: 'checkboxgroup', hidden: config.record.repeattype == 1 ? false : true // hide on load
                        , items: [
                    ...
                    {
                        fieldLabel: _('mxcalendars.label_repeat_frequency'), name: 'repeatfrequency', id: 'crepeatfrequency', xtype: 'combo', mode: 'local', store: new Ext.data.ArrayStore({
                        id: 0,
                        fields: ['counter'],
                        data: [
                            [],
                    ...
                    }), displayField: 'counter', valueField: 'counter', editable: true, width: 50, layout: 'anchor', anchor: '100% 100%', value: config.record.repeatfrequency, msgTarget: 'crepeatfrequency', msgDisplay: 'block', listeners: {
                        render: function (c) {
                    ...
                    {
                        fieldLabel: _('mxcalendars.label_repeat_last_occurance'), name: 'repeatenddate', id: 'crepeatenddate', width: 120, layout: 'anchor', anchor: '100% 100%', format: mxcCore.config.mgr_dateformat, allowBlank: false, xtype: 'datefield', value: config.record.repeatenddate, submitValue: false
                    }
                ]
            },
            {
                xtype: 'container', anchor: '100%', layout: 'form', items: [
                {
                    xtype: 'tabpanel', plain: true, activeTab: 0, height: 385
                    //,autoHeight: true
                    , width: 840, defaults: {bodyStyle: 'padding:10px', layout: 'form'}, items: [
                    {
                        cls: 'x-plain',
                        title: _('mxcalendars.label_description'),
                        layout: 'fit',
                        items: {
                            xtype: mxcCore.config.event_desc_type == 'htmleditor' ? 'textarea' : mxcCore.config.event_desc_type, name: 'description', hiddenName: 'description', id: 'cdescription', value: config.record.description
                        }, listeners: {
                    ...
                    },
                    {
                        ...
                        layout: 'fit',
                        items: {
                            xtype: mxcCore.config.event_desc_type == 'htmleditor' ? 'textarea' : mxcCore.config.event_desc_type, name: 'content', hiddenName: 'content', id: 'ccontent', value: config.record.content
                        }, listeners: {
                        activate: function (tabpanel) {
                    ...
                    },
                    {
                        ...
                        layout: 'fit',
                        items: {
                            xtype: 'mxc-images-grid', id: 'gridimages'
                        }
                    },
                    {
                        cls: 'x-plain',
                        ...
                        layout: 'fit',
                        items: {
                            xtype: 'mxc-videos-grid', id: 'gridvideos'
                        }
                    },
                    {
                        title: _('mxcalendars.label_location'), defaults: {width: 230}, defaultType: 'textfield', items: [
                        {
                            fieldLabel: _('mxcalendars.label_name'), name: 'location_name', id: 'clocation_name', value: config.record.location_name
                        },
                        {
                            fieldLabel: _('mxcalendars.label_address'), name: 'location_address', id: 'clocation_address', value: config.record.location_address
                        },
                        {
                            boxLabel: _('mxcalendars.label_display_map'), name: 'map', id: 'cmap', xtype: 'checkbox', checked: config.record.map ? true : false
                        }
                    ]
                    },
                    {
                        ...
                        items: [
                            {
                                fieldLabel: 'Link', name: 'link', id: 'clink', allowBlank: false, value: config.record.link
                            },
                            {
                                fieldLabel: _('mxcalendars.label_link_rel'), name: 'linkrel', id: 'clinkrel', value: config.record.linkrel
                            },
                            {
                                fieldLabel: _('mxcalendars.label_link_target'), name: 'linktarget', id: 'clinktarget', xtype: 'combo', mode: 'local', store: new Ext.data.ArrayStore({
                                id: 0,
                                fields: ['tt'],
                                data: [
                                    ['_self'],
                            ...
                            }), triggerAction: 'all', displayField: 'tt', valueField: 'tt', editable: true, width: 'auto', anchor: '30%', value: config.record.linktarget
                            }
                        ]
                    },
                    {
                        title: "Form", defaults: {width: 230}, items: [
                        {
                            xtype: 'combo',
                            displayField: 'name',
                            valueField: 'name',
            ...
            {
                xtype: 'checkbox', boxLabel: _('mxcalendars.category_active_col_label'), id: 'cactive', name: 'active', hiddenName: 'active', checked: true, value: 1
            }
        ], buttons: [
            {
                text: _('mxcalendars.label_cancel'), type: 'close', handler: function () {
                Ext.getCmp('CreateCal').hide();
            }
            },
            {
                text: _('mxcalendars.label_save'), handler: function () {
                ...
                var frmData = {
                    ...
                    , link: Ext.getCmp('clink').getValue(), linkrel: Ext.getCmp('clinkrel').getValue()
                    ...
                    , HTTP_MODAUTH: MODx.siteId, action: 'mgr/events/create'
                };
    ...
    this.mxcEvent = Ext.applyIf(config, {
        ...
        items: [
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {//@ack
                                ...
                                mode: 'remote',
                                triggerAction: 'all',
                                fieldLabel: _('mxcalendars.tag_tags'),
                                name: 'tagid',
                                hiddenName: 'tagid',
                                id: 'tagid',
                                allowBlank: true,
                                ...
                                items: [
                                    {
                                        ...
                                        allowBlank: false,
                                        width: 150,
                                        value: config.record.startdate_date, listeners: {select: {fn: function (ths, value) {
                                    ...
                                    },
                                    {
                                        ...
                                        value: config.record.startdate_time, listeners: {change: {fn: function (tht, value) {
                                        var edt = Ext.getCmp('enddate_time');
                                        if (edt.getValue() == '') {
                                            edt.setValue(value);
                                        }
            ...
            },
            {
                ...
                layout: 'form',
                items: [
                    {name: 'repeating', id: 'repeating', xtype: 'hidden', value: config.record.repeating ? 1 : 0},
                    {
                        fieldLabel: _('mxcalendars.label_repeat_type'), name: 'repeattype', id: 'repeattype', xtype: 'combo', mode: 'local', store: new Ext.data.ArrayStore({
                        id: 0,
                        fields: ['v', 'measure'],
                        data: [
                            [0, _('mxcalendars.label_daily')],
                    ...
                    {
                        fieldLabel: _('mxcalendars.label_repeaton'), name: 'repeaton', id: 'repeaton', xtype: 'checkboxgroup', hidden: config.record.repeattype == 1 ? false : true // hide on load
                        , items: [
                        {boxLabel: _('mxcalendars.label_sunday'), name: 'cb-auto-1', value: -1, checked: config.record.repeaton.indexOf(',-1,') != -1 ? true : false },
                        {boxLabel: _('mxcalendars.label_monday'), name: 'cb-auto-2', value: 0, checked: config.record.repeaton.indexOf(',0,') != -1 ? true : false },
                        {boxLabel: _('mxcalendars.label_tuesday'), name: 'cb-auto-3', value: 1, checked: config.record.repeaton.indexOf(',1,') != -1 ? true : false },
                    ...
                    {
                        fieldLabel: _('mxcalendars.label_repeat_frequency'), name: 'repeatfrequency', id: 'repeatfrequency', xtype: 'combo', mode: 'local', store: new Ext.data.ArrayStore({
                        id: 0,
                        fields: ['counter'],
                        data: [
                            [],
                    ...
                    {
                        fieldLabel: _('mxcalendars.label_repeat_last_occurance'), name: 'repeatenddate', id: 'repeatenddate', format: mxcCore.config.mgr_dateformat, allowBlank: false, xtype: 'datefield', value: config.record.repeatenddate, submitValue: false, width: 120, layout: 'anchor', anchor: '100% 100%'
                    }
                ]
            },
            {
                    ...
                    items: [
                        {
                            ...
                            layout: 'fit',
                            items: {
                                xtype: mxcCore.config.event_desc_type == 'htmleditor' ? 'textarea' : mxcCore.config.event_desc_type, name: 'description', hiddenName: 'description', id: 'description-' + config.record.id, value: config.record.description
                            }, listeners: {
                            activate: function (tabpanel) {
                                //if(MODx.config.use_editor && MODx.loadRTE && mxcCore.config.event_desc_type == 'htmleditor'){
                                //    MODx.loadRTE('description-'+config.record.id);
                        ...
                        },
                        {
                            ...
                            layout: 'fit',
                            items: {
                                xtype: mxcCore.config.event_desc_type == 'htmleditor' ? 'textarea' : mxcCore.config.event_desc_type, name: 'content', hiddenName: 'content', id: 'content-' + config.record.id, value: config.record.content
                            }, listeners: {
                            activate: function (tabpanel) {
                                if (MODx.config.use_editor && MODx.loadRTE) {
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                {
                                    fieldLabel: _('mxcalendars.label_address'), name: 'location_address', id: 'location_address', value: config.record.location_address
                                },
                                {
                                    boxLabel: _('mxcalendars.label_display_map'), name: 'map', id: 'map', xtype: 'checkbox', checked: config.record.map ? true : false
                                }
                            ]
                        },
                        {
                            ...
                            items: [
                                {
                                    fieldLabel: 'Link', name: 'link', id: 'link', allowBlank: false, value: config.record.link
                                },
                                {
                                    fieldLabel: _('mxcalendars.label_link_rel'), name: 'linkrel', id: 'linkrel', value: config.record.linkrel
                                },
                                {
                                    fieldLabel: _('mxcalendars.label_link_target'), name: 'linktarget', id: 'linktarget', xtype: 'combo', mode: 'local', store: new Ext.data.ArrayStore({
                                    id: 0,
                                    fields: ['tt'],
                                    data: [
                                        ['_self'],
            ...
            {
                xtype: 'checkbox', fieldLabel: _('mxcalendars.category_active_col_label'), id: 'active', name: 'active', hiddenName: 'active', checked: config.record.active ? true : false, value: 1
            }
        ], buttons: [
            {
                text: _('mxcalendars.label_cancel'), type: 'close', handler: function () {
...
//                console.log("New RepeatON: "+repeatDOW);
                var frmData = {
                    ...
                    tags: Ext.getCmp('tagid').getValue(), //@ack
                    ...
                    // @TODO move to proper config section
                    , HTTP_MODAUTH: MODx.siteId, action: 'mgr/events/update'
                };
